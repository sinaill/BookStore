...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/orderinfo.js"></script>
		
	<script type="text/javascript">
		$('#btnClientRegister2').onsubmit(function(){
			return false;
		})
	</script>
	...
	<body>&nbsp; 
		...
		<div class="fill_message">
			<p>
				选择地址：
				<select id="address">
					<option value="-1">新地址</option>
				</select>
			</p>
			<form name="ctl00" method="post" action="addorder" id="f">
				<s:token></s:token>
				<input type="hidden" name="address_id" id="addressId" value="-1"/>
				...
				<table class="tab_login">
					<tr>
						...
						<td>
							<input type="text" class="text_input" name="address.reciever_name"
								id="recieveName" />
				...
				<div class="login_in">
					...
					<a href="cartlist"><input id="btnClientRegister2" class="button_1" name="submit"
