...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function SameH(sidebar,right)
		{
		    ...
		    {
		        b.style.height= a.scrollHeight-23+"px";
		    }
		}
	...
	<body>
		...
		<div class="book">
			...
			<!--左栏开始-->
			<div id="left" class="book_left" style="background-color:white;height:820px">
			...
			<div class="book_center">
				...
				<!--图书列表开始-->
				<div id="divRight" class="list_right" style="margin-top:-10px;width:761px;background-color:white;">
						...
						<div id="divTopPageNavi" class="list_r_title_text3">
							...
							<div class='list_r_title_text3a'>
								<a name=link_page_next
									href="productlist.action?category_id=${category_id }&page=${page-1 }">
			...
			<s:iterator value="products">
					...
					<!--  <div class="clear"></div>-->
					<div id="divTopPageNavi" class="list_r_title">
					<s:if test="page > 1">
							<div class='list_r_title_text3a' style="margin-top:7px;margin-left:300px">
								<a name=link_page_next
									href="productlist.action?category_id=${category_id }&page=${page-1 }">
								<img src='../images/page_up.gif' /> 
								</a>
							...
							<div class='list_r_title_text3b' style="line-height: 29px;">
								第${page }页/共${totalPage}页
							</div>
							<s:if test="page < totalPage">
							<div class='list_r_title_text3a' style="margin-top:7px;">
								<a name=link_page_next
									href="productlist.action?category_id=${category_id }&page=${page+1 }">
									<img src='../images/page_down.gif' />
								 </a>
		...
		<script type="text/javascript">SameH("left","divRight");</script>
		<!--页尾开始 -->
